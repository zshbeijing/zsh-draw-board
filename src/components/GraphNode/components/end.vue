<template>
  <g>
    <circle :cx="polygonX" :cy="polygonY" :r="`${(props.graphProperties.r! - 7 || 0)}`" stroke="white" fill="white" stroke-width="2"  />
    <circle :cx="polygonX" :cy="polygonY" :r="props.graphProperties.r" stroke="white" fill-opacity="0" stroke-width="5"  />
